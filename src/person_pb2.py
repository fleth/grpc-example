...
_PARAMS = _descriptor.Descriptor(
  name='Params',
  full_name='tutorial.Params',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tutorial.Params.name', index=0,
...
_INFOMATION = _descriptor.ServiceDescriptor(
  name='Infomation',
  full_name='tutorial.Infomation',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Get',
    full_name='tutorial.Infomation.Get',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_INFOMATION)

DESCRIPTOR.services_by_name['Infomation'] = _INFOMATION
